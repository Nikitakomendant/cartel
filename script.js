...
(function initReveal() {
  ...
  const autoTargets = document.querySelectorAll(
    '.venue-card, .stat-item, .contact-card, .feature-item, .booking-form, .philosophy-visual, .timeline-card, .beyond-card, .pillar-card, .department-card, .message-form-wrap, .hotel-card, .venue-feature, .venue-cta-card, .booking-cta-card'
  );
